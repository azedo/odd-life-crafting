        ...
        <div className="image-gallery__content">
          <div className="image-gallery__header">
            ...
            <button onClick={e => this.props.closeModalFn(e, null)} className="image-gallery__close">
              <span>
                <svg fill="white" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 512 512" style={{ enableBackground: "new 0 0 512 512" }} xmlSpace="preserve">
